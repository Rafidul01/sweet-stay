      ...
      >
        <SwiperSlide>
          ...
          <div className="bg-gradient-to-r from-black p-4  rounded-2xl">
                <h1 className=" md:text-5xl text-white font-extrabold md:w-[750px] text-center text-opacity-100 font-roboto">Choose your Hotel, Resorts, Longe and many more with <br /> Sweet <span className="text-orange-400">Stay</span></h1>
            </div>
          </div>
        </SwiperSlide>
        <SwiperSlide>
