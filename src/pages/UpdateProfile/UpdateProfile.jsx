    ...
    <div className="hero min-h-screen font-poppins">
      <div className="flex flex-col md:flex-col gap-4 justify-center items-center " >
        ...
        >
          ...
          <div className=" h-64 md:w-96 md:h-96  ring ring-[#FFA920] ring-offset-base-100 ring-offset-2 rounded-2xl">
          ...
          <form className="card-body ">
            <div className="form-control">
              ...
              />
              <div className="label">
                <Link onClick={handleNameInput} className="btn bg-transparent border-[#FFA920] text-[#FFA920] hover:bg-[#FFA920] hover:text-white">Edit<MdEdit /></Link>
              </div>
              </div>
            </div>
            <div className="form-control">
            ...
            <div className="form-control">
              ...
              />
               <div className="label">
                <Link onClick={handlePhotoInput} className="btn bg-transparent border-[#FFA920] text-[#FFA920] hover:bg-[#FFA920] hover:text-white">Edit<MdEdit />
</Link>
              </div>
              </div>
            ...
            <p>
              ...
              <small className="text-black opacity-80">
                Please use {" "}
                <span className="text-[#FFA920]">Edit </span>
                button to update your{" "}
                <span className="text-[#FFA920]">
                  Name and Photo URL
                </span>{" "}
                and hit <span className="text-[#FFA920]">
                  Save Changes
                </span> to update your Profile
              </small>
            </p>
            <div className="form-control">
              <button className="btn bg-[#FFA920]  text-white">Save Changes</button>
            </div>
          </form>
        </div>
      </div>
